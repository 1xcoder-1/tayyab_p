...
const MyPlaygroundPage = () => {
  const projectDetails = {
    ...
    description: "My Playground is a trucking management system that helps truckers manage their fleet and improve their efficiency.",
    image: 'https://framerusercontent.com/images/r0RRWl16HsbxtaRhjF1jcLcw6wI.gif?scale-down-to=512&width=1920&height=1080',
    role: "UX/UI Design",
  ...
  return (
    <div className="min-h-screen bg-[#121314] text-white relative overflow-hidden selection:bg-blue-500/30">
      ...
      <div className="relative z-10 bg-[#121314] flex flex-col items-center gap-8 md:gap-16 pb-16">
        ...
        >
          <img
            src='https://framerusercontent.com/images/hrQGHnEGv3voip9mUU8g1QBCHis.jpg?scale-down-to=2048&width=2524&height=1517'
        ...
        >
          <img
            src='https://framerusercontent.com/images/AvF5wJteV9mQMdiMQBJCjh3w.gif?width=1920&height=1080'
        ...
        >
          <img
            src='https://framerusercontent.com/images/5xaR2xafuxXUYdytSBirkj8AE.png?scale-down-to=2048&width=3840&height=2160'
        ...
        >
          <img
            src='https://framerusercontent.com/images/wNRPxkRJjaPuKfcBvnXVtvQ5ChY.gif?width=1600&height=1200'
            alt="Navigation Map"
            className="w-full h-auto object-cover shadow-2xl"
          />
        </motion.div>

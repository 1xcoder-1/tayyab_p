...
const CommandTMSPage = () => {
  const projectDetails = {
    ...
    description: "Command TMS is a trucking management system that helps truckers manage their fleet and improve their efficiency.",
    image: 'https://framerusercontent.com/images/Jtnq93J0CMfJ4WbWSHVfwXX9NU.jpg?scale-down-to=2048&width=5760&height=3240',
    role: "UX/UI Design",
  ...
  return (
    <div className="min-h-screen bg-[#121314] text-white relative overflow-hidden selection:bg-blue-500/30">
      ...
      <div className="relative z-10 bg-[#121314] flex flex-col items-center gap-8 md:gap-16 pb-16">
        ...
        >
          <img
            src='https://framerusercontent.com/images/Jtnq93J0CMfJ4WbWSHVfwXX9NU.jpg?scale-down-to=2048&width=5760&height=3240'
        ...
        >
          <img
            src='https://framerusercontent.com/images/VbkkKj0YIsuFUcFgrQjP3c024HY.jpg?scale-down-to=2048&width=5760&height=3240'
        ...
        >
          <img
            src='https://framerusercontent.com/images/jlyFVF4QgOtL8hl0kXvi0YHf1D0.jpg?scale-down-to=2048&width=5760&height=3240'
        ...
        >
          <img
            src='https://framerusercontent.com/images/IoSmIETx6ScVUjqoGJxLsf1MBg.jpg?scale-down-to=2048&width=5760&height=3240'
            alt="Navigation Map"
            className="w-full h-auto object-cover shadow-2xl"
          />
        </motion.div>
